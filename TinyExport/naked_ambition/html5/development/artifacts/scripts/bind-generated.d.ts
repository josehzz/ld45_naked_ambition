...
declare namespace game{
    ...
    class InventoryConfiguration extends ut.Component {
        constructor();
        static readonly cid: number;
        static readonly _view: any;
        static readonly _isSharedComp: boolean;
        static _size: number;
        static _fromPtr(p: number, v?: InventoryConfiguration): InventoryConfiguration;
        static _toPtr(p: number, v: InventoryConfiguration): void;
        static _tempHeapPtr(v: InventoryConfiguration): number;
        static _dtorFn(v: InventoryConfiguration): void;
    }
    class ItemConfiguration extends ut.Component {
        constructor();
        static readonly cid: number;
        static readonly _view: any;
        static readonly _isSharedComp: boolean;
        static _size: number;
        static _fromPtr(p: number, v?: ItemConfiguration): ItemConfiguration;
        static _toPtr(p: number, v: ItemConfiguration): void;
        static _tempHeapPtr(v: ItemConfiguration): number;
        static _dtorFn(v: ItemConfiguration): void;
    }
}
declare namespace ut{
}
